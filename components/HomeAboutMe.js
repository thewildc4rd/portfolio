...
const HomeAboutMe = (props) => {
  ...
  return (
    <div className='h-full w-full flex-1' ref={ref}>
      ...
      <p className='mt-4 text-lg'>
        I am on track to graduate by the end of this year so I am actively seeking 2025 graduate
        roles and 2024/25 Summer internships for Software Engineering, IT, Commerce, and/or
        Economics.
      </p>
