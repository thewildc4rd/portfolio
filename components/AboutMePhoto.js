...
const AboutMePhoto = (props) => {
  ...
  return (
    <div className='h-full w-[500px] relative flex justify-center items-center'>
      <div
        ref={ref}
        className='card-1 opacity-0 w-full h-full max-w-[350px] max-h-[400px] rounded-3xl absolute z-[3] translate-x-3 translate-y-96 flex items-end shadow-xl overflow-hidden'
        style={{
      ...
      <div
        className='card-2 w-full h-full max-w-[350px] max-h-[420px] p-5 text-pink-800 text-opacity-40 rounded-3xl absolute z-[2] -translate-x-6 -translate-y-8 -rotate-12 shadow-xl overflow-hidden'
        style={{
          opacity: isInView ? 100 : 0,
          transform: isInView
      ...
      <div
        className='card-3 w-full h-full max-w-[450px] max-h-[350px] p-5 text-yellow-600 text-opacity-40 rounded-3xl absolute z-[1] translate-y-8 -rotate-12 shadow-xl overflow-hidden'
        style={{
          opacity: isInView ? 100 : 0,
